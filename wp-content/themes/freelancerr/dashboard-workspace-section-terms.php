<div class="row">
	<div class="large-12 columns">
		<fieldset>
			<legend><?php _e( 'Employer Terms', APP_TD ) ?></legend>
			...
			<?php foreach( $participants as $participant ): ?>
				...
				<?php  continue; endif; ?>
						...
						<fieldset>
							...
							<?php if ( $dashboard_user->ID != $participant->ID ) : ?>
								...
								<?php the_hrb_user_gravatar( $participant, 70 ); ?>
								<?php the_hrb_user_display_name( $participant ); ?>

							<?php endif; ?>

							<p id='dashboard-freelancer-terms'><?php echo ( $participant->development_terms ? $participant->development_terms : __( 'None specified', APP_TD ) ) ; ?></p>
						</fieldset>
				...
				<div class="row agreement-date">
					<div class="large-12 columns">
						<span class="label-meta right">Finalized on 
