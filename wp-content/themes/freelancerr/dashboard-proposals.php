						...
						<div class="large-12 columns">
							...
							<div class="large-10 columns projects-section">
								...
								<div class="row section-primary-info">
									<div class="<?php echo $proposal->_hrb_featured ? 'large-2 small-4' : 'large-2 small-3'; ?> columns proposal-amount">
									...
									<div class="<?php echo $proposal->_hrb_featured ? 'large-3 small-4' : 'large-3 small-3'; ?> columns proposal-delivery-date">
									...
									<div class="<?php echo $proposal->_hrb_featured ? 'large-3 small-3' : 'large-3 small-3'; ?> columns proposal-date">
									...
									<?php if ( ! $project_id ): ?>
									<div class="<?php echo $proposal->_hrb_featured ? 'large-4 small-4' : 'large-4 small-4'; ?> columns proposal-date">
										<span data-tooltip title="<?php echo __( 'Total Proposals', APP_TD ); ?>"class="large-12 columns total-proposals <?php echo ( $dashboard_user->ID == $project->post_author ? ' clickable-prop-list' : '' ); ?>">
								...
								<div class="row section-secondary-info">
									...
									<div class="large-3 small-4 columns proposals-actions">
										<?php rcktshp_the_hrb_dashboard_proposal_actions( $proposal, get_post( $project->ID ) ); ?>
									</div>
								</div>
