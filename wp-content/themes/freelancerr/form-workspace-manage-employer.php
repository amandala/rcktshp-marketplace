...
$ = jQuery;
	...
	$( document ).ready(function() {
		...
		if($('option[value="closed_complete"]').length > 0){
			//$("#project_status").val(optionValue).find("option[value=canceled]").attr('selected', false);
			//$("#project_status").val(optionValue).find("option[value=closed_complete]")setAttribute("selected","selected");
			$('.hidden-field option[value="closed_complete"]').attr('selected', 'selected');
