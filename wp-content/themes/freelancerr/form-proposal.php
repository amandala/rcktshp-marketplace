		...
		<div class="row">
			<div class="large-12 columns">
				<div class="row collapse featured-option">
					...
					<i class="fa fa-question-circle has-tip" data-tooltip aria-haspopup="true"  title="Featuring a proposal lets the employer know you are serious about working on their project. Your proposal will appear at the top of the list."></i>
				</div>
			</div>
		</div>
	</fieldset>
				...
				<div class="row collapse">
					<div class="large-12 columns">
						<p>
							...
							<span class="custom checkbox"></span> <?php echo html( 'a', array( 'target' => '_new', 'href' =>site_url() . "/terms/", 'class' => 'site-terms-link' ), __( 'I agree with site terms', APP_TD ) ); ?>
						</p>
					</div>
				</div>
				<div class="row collapse">
					<div class="large-12 column">
						...
						<input type="submit" id="submit_proposal" class="agree button" disabled onclick='return confirm("<?php echo __( 'You are applying to this project. Proceed?', APP_TD ); ?>")' value="<?php echo esc_attr( $bt_step_text ); ?>" />
					</div>
...
<script>
	jQuery( document).ready( function(){
		jQuery('#amount').change(function(){
			...
			jQuery('#calc-amount').html('Your net pay: $'+  calc + ' <a href="<?php echo site_url()?>/service-fees">Details</a>');
		});
	});
