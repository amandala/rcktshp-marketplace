	...
	<div class="row">
		<div class="large-12 columns">
			...
			<?php if ( ! empty( $proposal->_hrb_candidate_decision ) ): ?>
					...
					<fieldset>
						 <div class="candidate-decision <?php echo  esc_attr( $proposal->_hrb_candidate_decision ); ?>"><?php echo "Freelancer Decision: ".hrb_get_agreement_decision_verbiage( $proposal->_hrb_candidate_decision ); ?></div>
						<?php if ( $proposal->_hrb_candidate_notes ): ?>

							<div class="candidate-decision-notes"><?php
							echo $proposal->_hrb_candidate_notes; ?></div>
						<?php endif; ?>
					</fieldset>
						<h5><?php _e( 'Employer Terms', APP_TD ); ?></h5>
						<p>If there were none provided, simply select Accept.</p>

					<fieldset  class='grey-back'>
								<div class="proposal-terms"><?php echo esc_textarea( $proposal->_hrb_development_terms ? $proposal->project->_hrb_development_terms : __( 'None', APP_TD )   ); ?></div>
							</fieldset>
			...
			<?php if ( $user_can_edit_agreement_terms ): ?>
				...
				<fieldset>
					...
					<p class="terms_instruction">In the space provided below, please specify any additional terms you want to add to the project. These will be added to the official terms and will be documented in the project workspace. </p>
