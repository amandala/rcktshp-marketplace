<div class="large-12 columns">
	<h2 class="centered"><i class="icon i-notifications"></i><?php echo __( 'Notifications', APP_TD  ); ?></h2>
						...
						<tbody>
							...
							?>
								...
								<tr>
									...
									<td>
										<div class="message"><?php echo ( 'unread' == $notification->status ? html( 'strong', strip_tags($notification->message) ) : strip_tags($notification->message) ); ?></div>
