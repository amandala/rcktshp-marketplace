<?php
/**
 * The template for displaying package listings
 */
?>
...
<div  class="project-archive-wrapper">
    <div id="package-header">
        <h3>Browse all our packages and discover new ways to enhance your small business</h3>
    </div>
    <?php
    //for a given post type, return all
    $post_type = 'packages';
    $tax = 'package_category';
    $tax_terms = array_reverse(get_terms($tax));

    if ($tax_terms) {

        foreach ($tax_terms  as $tax_term) { ?>
        <div class="package-archive-section" id="packages-<?php echo $tax_term->slug ?>">
            <div class="packages-wrapper large-10 columns push-1">
                <h4 class="centered"><?php echo ucfirst($tax_term->name); ?> Packages</h4>
            <?php
    ...
    <div class="full-width-div override">
        <h3 class="centered">Small business help with a Satisfaction Guarantee</h3>
