<?php
/*
Template Name: Support Local - Registered
*/
?>
<?php
...
if(isset($_POST['email'])){
	...
	if(isset($_POST['entry'])){
		...
		if($user){
			$user_id = $user->ID;
			update_user_meta( $user_id, 'support_local_entry', $entry);
		...
		$email_subject = 'Thank You For Applying To The Support #Local Scholarship';
...
<div class='large-10 push-1 columns' id='scholarship-banner'>
	<img style="width:100%;" src="<?php echo site_url()?>/wp-content/themes/freelancerr/images/scholarship/support_local_banner.jpg">
	<a name="banner"></a>

	<div class="form-greeting" id="greeting">
		<h3 class="greeting">What's your favorite #Local business?</h3>
		<p class='instruction pad'>Tell us about your favorite 3 #Local businesses or not-for-profits. Then, tweet about each individually with #LocalBusiness @RCKTSHP. Remember to log in and fill out your profile as best you can to complete your entry.</p>
	</div>
	...
	<div class="large-10 push-1 columns form-greeting" id ="heading4">
		...
		<p class='instruction'>You've successfully entered The Support #Local Schoalarship</p>
			...
			<form method="post" action="" id="already-reg-form">
				<fieldset class="scholarship-section" >
					...
					<div class="large-12 columns">
						...
						<label class='scol-label'>Tell us about your three favorite #Local businesses.</label>
					...
					<div class="large-4 columns">
						<div class='submit-form-section'>
							<button id='already-reg-submit' type="button" name="btnscholarship" class="schol-button next" onclick="ga('send', 'event', 'SAPform', 'Click', 'Submit');">SUBMIT</button>
