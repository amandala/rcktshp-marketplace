	...
	<div class="row">
		<div class="large-12 columns">
			...
			<?php if ( ! empty( $proposal->_hrb_employer_decision ) ): ?>
					...
					<fieldset>
						<div class="employer-decision <?php echo esc_attr( $proposal->_hrb_employer_decision ); ?>"><?php echo "The Employer: " . hrb_get_agreement_decision_verbiage( $proposal->_hrb_employer_decision ); ?></div>
