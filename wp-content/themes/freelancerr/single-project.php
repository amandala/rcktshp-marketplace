<?php the_post(); ?>
<div class="large-12 columns" id="single-project-page">
...
<div id="main" class="large-8 columns">
	...
	<div id="project" <?php post_class( 'single-project' ); ?>>
		...
		<div class="section-container project-leaves">
			<div class="project-header-wrapper">
				...
				<div class="single-project-header row">
					...
					<div class="bid large-4 small-5 columns large-offset-2">
						<a href="#clarification-board" id="project-comments" class="button expand">Project Comments</a>
		...
		<div class="section-container auto section-tabs project-trunk" data-section>
			...
			<section class="single-project-tabs" id="proposals">

				<p class="title single-project"><a href="#proposals"><?php echo sprintf( __( 'Proposals (%s)', APP_TD ), appthemes_get_post_total_bids( get_the_ID() ) ); ?></a></p>
			...
			<section id="clarification-board" class="active single-project-tabs">

				<p class="title single-project "><a href="#clarification"><?php echo sprintf( __( 'Clarification Board (%s)', APP_TD ), get_comments_number() ); ?></a></p>
...
<div id="sidebar-single-project" class="large-4 columns">
