...
<div id="dashboard-sidebar" class="large-4  columns dashboard-side">
	...
	<div class="sidebar-widget-wrap cf">
		...
		<h3 id='sidebar-greeting'><?php echo sprintf( __( 'Welcome %s', APP_TD ), $dashboard_user->display_name ); ?></h3>
		<aside id="dashboard-side-profile">
		<div class="dashboard-user-meta cf">
			<div class="user-gravatar"><?php the_hrb_user_gravatar( $dashboard_user->ID, 300 ); ?></div>
				<div class='button orange' id='edit-profile-button'><?php echo html_link( appthemes_get_edit_profile_url(), __( 'Edit Profile', APP_TD ) ); ?></div>
