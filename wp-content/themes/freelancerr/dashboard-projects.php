...
<div class="row content-projects">
	<div class="large-12 columns">
		...
		<div class="section-container auto section-tabs project-trunk" data-section>
			...
			<section class="dashboard-projects <?php echo esc_attr( 'projects' == hrb_get_dashboard_page() ? 'active' : '' ); ?>">
			...
			<section class="dashboard-projects <?php echo esc_attr( 'favorites' == hrb_get_dashboard_page() ? 'active' : '' ); ?>">
