<div class="large-12 columns" id = "dashboard-front-page">
<h2 class="centered"><i class="icon i-activity"></i><?php echo __( 'Your Recent Activity', APP_TD  ); ?></h2>
						...
						<div class="row">
							<div class="large-12 columns entry">
								...
								<div class="large-9 small-9 columns notification-message">
									<?php echo strip_tags($notification->message); ?>
