<div class="row single-bid">
	...
	<div class="large-8 small-9 columns">
		<p class="bidder-info"><?php the_hrb_user_gravatar( $proposal->user_id, 90 ); ?><span class="bidder-display-name"><?php the_hrb_user_display_name( $proposal->user_id ); ?></span></p>
