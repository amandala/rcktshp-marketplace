	...
	<div class="row">
		<div class="large-12 columns">
			...
			<?php if ( ! empty( $proposal->_hrb_candidate_decision ) ): ?>
					...
					<fieldset>
								<legend><?php _e( 'Freelancer Terms', APP_TD ); ?></legend>
			...
			<?php if ( $user_can_edit_agreement_terms ): ?>
				...
				<fieldset>
					...
					<p class="terms_instruction">In the space provided below, please specify all terms associated with this project. These will become the official terms and will be documented in the project workspace.</p>
