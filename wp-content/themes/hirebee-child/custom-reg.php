...
<div class='large-10 push-1 columns' id='scholarship-banner'>
	<img src="<?php echo site_url()?>/wp-includes/images/scholarship-banner1200.jpg">
	<a name="banner"></a>
	...
	<div class="form-greeting" id ="heading">
		...
		<h3 class="instruction pad">RCKTSHP is pleased to announce the <span class='greet-teal'>RCKTSHP Marketplace</span>.</h3>
		...
		<p class='instruction pad'>We’re awarding $500 to one deserving student who registers as a freelancer on the RCKTSHP Marketplace and has a <span class='greet-teal'>thoroughly completed profile.</span></p>
	...
	<div class="form-greeting" id ="heading4">
		...
		<p class='instruction'>You've successfully registered for the Marketplace and can apply for jobs right away. You're on your way to earning valuable work experience.</p>
		...
		<p>Your scholarship application was successfully received and you are now a member of the RCKTSHP Marketplace.</p>
					...
					<p>Now that you've successfully registered and completed your profile here's what you can do:
						<ul>
							...
							<li><a href='projects.rcktshp.com/projects/''>Browse projects</a> on our job postings board</li>
		...
		if(isset($_POST['task']) && $_POST['task'] == 'register' ) {
			...
			if( $description == "" ) {
				...
				$err = 'Nice try! That email address has already been registered. <br />If you are already a member of the RCKTSHP Marketplace and want to apply for the scholarship, email us at <a style="color: white; text-decoration:underline;" href="mailto:hello@rcktshp.com">hello@rcktshp.com</a> and we will enter you in! ';
			} else if($pwd1 <> $pwd2 ){
				$err = 'Passwords did not match.';
			} else if($over18 != '' ){
				$err = "Unfortunately you need to be at least 18 and agree to our terms to sign up on the Marketplace. If you are over 18, please review the <a href='<?php echo site_url()?>/terms/' target='_blank' style='color:white; text-decoration:underline'>site terms</a> and try again.";
			}
			else {
...
<div class='large-12 columns' id='full-sec'>
					...
					<div id="signup-section">
						...
						<fieldset class="scholarship-section" >
							...
							<div class="large-12 columns">
								...
								<br />
								<input class='schol-sign-check' type="checkbox" value="yes" name="over18" id="over18" style='margin: 0 0 0 0;'/> <span id='yes'>Yes, I am over 18 and I agree to the <a href='<?php echo site_url()?>/terms/' target='_blank'>RCKTSHP Marketplace Terms</a>  </span><i class="fa fa-question-circle" id='paypal-tooltip' title='We require users of the Marketplace site to be at least 18 years old. '></i>
							</div>
						</fieldset>
		...
		<!-- SIDEBARS -->
			<div class='large-4 columns schol-sidebar' id='sidebar-basic'>
				<h4 class='schol-sidebar-heading'>What Can I Do on the RCKTSHP Marketplace?</h4>
				...
				<p class='sidebar-schol'>Any project of a digital nature can be completed on the RCKTSHP Marketplace. This includes:
