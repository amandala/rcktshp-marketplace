	...
	<footer class="row footer">
		<div class="large-12 columns">
			...
			<div id="theme-info" class="footer-info large-7 columns">
				<div class="footer-credits"><a href="https://www.appthemes.com/themes/hirebee/" target="_blank" rel="nofollow">HireBee Theme</a> - <?php _e( 'Powered by', APP_TD ); ?> <a href="https://www.wordpress.org" target="_blank" rel="nofollow">WordPress</a>.</div>
			</div>
