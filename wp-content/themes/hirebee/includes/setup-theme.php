...
function _hrb_enqueue_core_styles() {
	...
	wp_enqueue_style(
		'hrb-normalize',
		get_template_directory_uri() . "/styles/core/normalize.min.css",
		array(),
		HRB_VERSION
	);
...
function _hrb_enqueue_core_scripts() {
	...
	$minified = hrb_get_minified_suffix();

	if ( wp_is_mobile() ) {

		wp_enqueue_script(
			'zepto',
			get_template_directory_uri() . '/scripts/core/zepto.min.js',
			false,
			HRB_VERSION,
			true
		);
	...
	wp_enqueue_script(
		'hrb-scripts',
		get_template_directory_uri() . "/scripts/scripts{$minified}.js",
		array( 'jquery' ),
		HRB_VERSION,
		true
	);
...
function hrb_register_common_scripts() {
	...
	wp_register_script(
		'hrb-user-edit',
		get_template_directory_uri() . "/scripts/user-edit{$minified}.js",
		null,
		HRB_VERSION,
		true
	);
...
function _hrb_register_styles() {
	...
	wp_register_style(
		'jquery-tagmanager',
		get_template_directory_uri() . '/scripts/jquery/tagmanager/jquery.tagmanager.min.css',
		array(),
		HRB_VERSION
	);
...
function _hrb_register_scripts() {
	...
	wp_register_script(
		'jquery-tagmanager',
		get_template_directory_uri() . '/scripts/jquery/tagmanager/jquery.tagmanager.min.js',
		array('jquery'),
		HRB_VERSION,
		true
	);
	...
	wp_register_script(
		'app-saved-filter',
		get_template_directory_uri() . "/scripts/saved-filters{$minified}.js",
		array('jquery'),
		HRB_VERSION,
		true
	);
	...
	wp_register_script(
		'app-project-edit',
		get_template_directory_uri() . "/scripts/project-edit{$minified}.js",
		array('jquery'),
		HRB_VERSION,
		true
	);
	...
	wp_register_script(
		'app-proposal-edit',
		get_template_directory_uri() . "/scripts/proposal-edit{$minified}.js",
		array('jquery'),
		HRB_VERSION,
		true
	);
	...
	wp_register_script(
		'app-dashboard',
		get_template_directory_uri() . "/scripts/dashboard{$minified}.js",
		array('jquery' ),
		HRB_VERSION,
		true
	);
	...
	wp_register_script(
		'app-workspace',
		get_template_directory_uri() . "/scripts/workspace{$minified}.js",
		array('jquery' ),
		HRB_VERSION,
		true
	);
	...
	wp_register_script(
		...
		get_template_directory_uri() . "/scripts/proposal-agreement{$minified}.js",
		array('jquery'),
		HRB_VERSION,
		true
	);
