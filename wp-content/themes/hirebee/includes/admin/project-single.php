...
class HRB_Project_Timeline_Meta extends HRB_Expire_Handler {
	...
	public function admin_enqueue_scripts(){
		wp_enqueue_style( 'jquery-ui-datepicker', get_template_directory_uri() . '/styles/jqueryui/jquery-ui.min.css' );
		wp_enqueue_script('jquery-ui-datepicker');
		wp_enqueue_style( 'wpjquery-ui-datepicker', APP_FRAMEWORK_URI . '/styles/datepicker/datepicker.css' );
	...
	public function before_form( $post ){
		...
		<script type="text/javascript">
			jQuery(function($){
				...
				$("#_blank_<?php echo HRB_PROJECTS_PTYPE; ?>_start_date").closest('tr').hide();
				$("#_blank_js_<?php echo HRB_PROJECTS_PTYPE; ?>_start_date").closest('tr').hide();
			});
		</script>
		...
		<script type="text/javascript">
			jQuery(function($){
				...
				<?php foreach( hrb_get_addons( HRB_PROJECTS_PTYPE ) as $addon ) { ?>
					...
					$("#<?php echo $addon; ?>_start_date").closest('tr').hide();
					$("#_blank_js_<?php echo $addon; ?>_start_date").closest('tr').hide();
