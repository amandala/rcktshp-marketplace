		...
		$this->tab_sections['general']['appearance'] = array(
			...
			'fields' => array(
				array(
					...
					'tip' => __( 'Use the WordPress Theme Customizer to try out different design options and other settings.', APP_TD ),
				),
				array(
		...
		$this->tab_sections['projects']['pricing'] = array(
			...
			'fields' => array(
				array(
					...
					'desc' => sprintf( __( 'Yes. You can manage your <a href="%s">Payments Settings</a> in the Payments Menu.', APP_TD ), 'admin.php?page=app-payments-settings'),
				),
				array(
		...
		$this->tab_sections['users']['location'] = array(
			...
			'fields' => array(
				array(
					...
					'type' => 'checkbox',
					'name' => 'local_users',
					'desc' => __( 'Restrict site to remote working. The location field will not be available on user profiles or when submitting projects.', APP_TD ),
		...
		$this->tab_sections['security']['security'] = array(
			...
			'fields' => array(
				array(
					...
					'type' => 'select',
					'name' => 'backend_access',
					'tip' => __( 'Allows you to restrict access to the WordPress Backend (wp-admin). '
							. 'Keeping this set to \'Admins Only\' is recommended. Select \'Disable\' if you have problems with this feature.', APP_TD ),
					'values' => array(
	...
	private function categories_options( $prefix ) {
		$fields = array(
			array(
				...
				'desc' => __( 'Display the quantity of posts in that category next to the category name.', APP_TD ),
			),
			array(
