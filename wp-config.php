...
/** CUSTOM CODE ADDED TO ACCOUNT FOR REDIRECTS AND SSL */

// Require WWW.
if (isset($_SERVER['PANTHEON_ENVIRONMENT']) &&
    $_SERVER['PANTHEON_ENVIRONMENT'] === 'live') {
  if ($_SERVER['HTTP_HOST'] == 'rcktshp.com' ||
      $_SERVER['HTTP_HOST'] == 'live-rcktshp-marketplace.pantheon.io') {
    header('HTTP/1.0 301 Moved Permanently');
    header('Location: http://www.rcktshp.com'. $_SERVER['REQUEST_URI']);
    exit();
  }
}
...
if (isset($_SERVER['PANTHEON_ENVIRONMENT']) &&
  ...
  if (!isset($_SERVER['HTTP_X_SSL']) ||
    ...
    header('HTTP/1.0 301 Moved Permanently');
    header('Location: https://www.rcktshp.com'. $_SERVER['REQUEST_URI']);
    exit();
  }
}